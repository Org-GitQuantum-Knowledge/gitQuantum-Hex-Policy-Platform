class BenchmarkApp {
    ...
    async runBenchmark() {
        ...
        try {
            ...
            // Simulate benchmark execution with realistic data
    ...
    async simulateBenchmark(ruleCount) {
        // Simulate realistic benchmark times based on rule count
        // HEX VM is typically slightly slower than OPA in this implementation
